...
- **df_miniapp/**: Main functionality of the TikTok app (1699 Java files, ~20MB)
...
- **df_rn_kit.config.\***: Configuration files for React Native kit
...
All source files are in `df_miniapp/classes/` directory (1699 Java files).
...
Original repository: https://github.com/huaji233333/tiktok_source

**Note**: This is reverse-engineered source code, not leaked source code.
